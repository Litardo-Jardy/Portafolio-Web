...
const Datos = () =>{
      return(
            <div className="Container-Datos">
                 <h1 className='Title-Datos'>Desarrollador web REACT.js Jr.</h1>

                 <div className='Container-Datos-I'>
                     <h3 className='h3-datos'>Fecha de nacimiento: </h3>
                     <span className='datos'>10 julio 2004</span>
                 </div>

                 <div className='Container-Datos-I'>
                     <h3 className='h3-datos'>Ubicacion: </h3>
                     <span className='datos'>Ecuador-Vinces</span>
                 </div>

                 <div className='Container-Datos-I'>
                     <h3 className='h3-datos'>Email: </h3>
                     <span className='datos'>jivan.litardo@gmail.com</span>
                 </div>

                 <div className='Container-Datos-I'>
                     <h3 className='h3-datos'>Estudios: </h3>
                     <span className='datos'>Tecnologo en desarrollo de sotfware (En proceso)</span>
                  </div>
                  <div className='Container-Descripcion'>
                     <p className='Parrafo'> Como programador junior especializado en el desarrollo de sistemas web con React.js, mi pasión por 
